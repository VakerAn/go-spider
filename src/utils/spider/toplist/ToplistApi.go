...
func (toplist *ToplistApi) Start() {
	allData := []string{
		"V2EX", "ZhiHu", "WeiBo", "TieBa", "DouBan", "TianYa", "HuPu", "GitHub", "BaiDu", "36Kr", "QDaily", "GuoKr", "HuXiu",
		"ZHDaily", "Segmentfault", "WYNews", "WaterAndWood", "HacPai", "KD", "NGA", "WeiXin", "Mop", "Chiphell", "JianDan", "ChouTi", "ITHome",
	}
